label day1:
    ...
    stas "Выпил лишнего."
    "Я закатил глаза."
    max "Да всего стаканчик-другой…"
    vera "Знаешь…"
    "Вероника попыталась сделать серьёзное лицо, но вышла забавная рожица."
    vera "Я, конечно, не доктор, но могу с уверенностью сказать, что для тебя слово “ром” и слово “смерть” означают одно и тоже."
    max "Эй, доктор Ливси, я не алкаш. У меня был повод."
    stas "Поводы у него…"
