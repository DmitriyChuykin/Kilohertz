...
screen say(who, what):
    ...
    hbox:
        ...
        imagebutton:
            idle "gui/quick/back_idle.png"
            hover "gui/quick/back_hover.png"

            action Rollback()

        imagebutton:
            idle "gui/quick/skip_idle.png"
            hover "gui/quick/skip_hover.png"
    ...
    hbox:
        ...
        imagebutton:
            idle "gui/quick/history_idle.png"
            hover "gui/quick/history_hover.png"

            action ShowMenu('history')

        imagebutton:
            idle "gui/quick/load_idle.png"
            hover "gui/quick/load_hover.png"
            xpos 20
            action ShowMenu('load')

        imagebutton:
            idle "gui/quick/save_idle.png"
            hover "gui/quick/save_hover.png"
            xpos 40
        ...
        imagebutton:
            idle "gui/quick/menu_idle.png"
            hover "gui/quick/menu_hover.png"
            xpos 80
